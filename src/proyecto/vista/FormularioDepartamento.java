...
public class FormularioDepartamento extends javax.swing.JFrame {
    ...
    public FormularioDepartamento() {
        initComponents();
        this.mostrarBusquedaDeDepartamento();
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("Formulario de Departamentos");
        ...
        boton_remover.setForeground(new java.awt.Color(0, 0, 255));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/departamento.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(1145, 656));
    ...
    private void boton_cambiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_cambiarActionPerformed
        ...
        departamento.setNombre(dato_nombre.getText());
        departamento.setDireccion(dato_direccion.getText());
        departamento_bd.cambioDepartamento(departamento, tabla.getValueAt(tabla.getSelectedRow(), 0));
        this.mostrarBusquedaDeDepartamento();
    ...
    private void boton_removerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_removerActionPerformed
        departamento_bd.bajaDepartamento(tabla.getValueAt(tabla.getSelectedRow(), 0));
        this.mostrarBusquedaDeDepartamento();
    ...
    public void mostrarBusquedaDeDepartamento() {
        ArrayList<Departamento> lista = departamento_bd.listarBusquedaDeDepartamentos(dato_busqueda.getText());
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
                objetos, new String[]{
                    "Numero de Departamento", "Nombre", "Dirección"
                }
        ));
    }
